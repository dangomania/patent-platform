...
2. Go to your repository at [collective/patent-platform](https://github.com/collective/patent-platform).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `patent-platform.lovedigression.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | patent-platform.lovedigression.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | patent-platform.lovedigression.com |
...
- [Backend Tests Workflow](https://github.com/collective/patent-platform/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/patent-platform/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/patent-platform-backend`) and Frontend (`ghcr.io/collective/patent-platform-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of patent-platform.lovedigression.com](https://github.com/collective/patent-platform/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/patent-platform.lovedigression.com.yml` stack.
