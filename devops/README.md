...
DEPLOY_ENV=prod
DEPLOY_HOST=patent-platform.lovedigression.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for patent-platform.lovedigression.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    patent-platform.lovedigression.com:
      ansible_user: root
      host: patent-platform
      hostname: patent-platform.lovedigression.com
```
...
Deploy the stack defined in `devops/stacks/patent-platform.lovedigression.com.yml` to the remote server with:
